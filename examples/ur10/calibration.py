...
if dataSet == "sample":
    ...
    plt.figure(6)
    plt.barh(
        param["param_name"][6 : -param["calibration_index"] * param["NbMarkers"]],
        res[6 : -param["calibration_index"] * param["NbMarkers"]],
        align="center",
        color="orange",
    )
    plt.grid()
    plt.figure(7)
    plt.barh(
        param["param_name"][-param["calibration_index"] * param["NbMarkers"] :],
        res[-param["calibration_index"] * param["NbMarkers"] :],
        align="center",
        color="green",
    )
    plt.grid()
